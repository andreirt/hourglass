...
void ofApp::setup(){
    ...
    ofxUILabel* titleLabel = new ofxUILabel(10, 10, 500, "title", "Ampulheta", OFX_UI_FONT_LARGE);
    titleLabel->setColorFill(ofxUIColor::black);
    this->gui->addWidget(titleLabel);
    ...
    cameraHeightLabel->setColorOutline(ofxUIColor::red);
    this->gui->addWidgetRight( cameraHeightLabel );
    ...
    white.a = 255;
    ofColor darkRed = ofColor::darkRed;
    ofColor red = ofColor::red;
    ofColor lightGray = ofColor::gray;
    ofColor gray = ofColor::black;
    ofColor darkGreen = ofColor::darkGreen;
    ofColor green = ofColor::green;

    this->gui->setUIColors(white, darkRed, red, lightGray, gray, darkGreen, green );
